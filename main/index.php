  	...
  	<br>
  		<div class="row">
		    <div class="input-field col s12">
			    <select id="personListType" onchange="loadPersonFresh()">
		  	...
		  	<div id="personMonthDiv" class="dateDiv col s6">
                 <select id="personMonthValue" onchange="loadPersonFresh()">
              ...
              <div id="personYearDiv" class="dateDiv col s6">
                 <select id="personYearValue" onchange="loadPersonFresh()">
...
<!-- Modal Structure -->
  ...
  <div id="loadItemPaymentData" class="itemPersonData modal bottom-sheet modal-fixed-footer">
    <div class="modal-content personPaymentData">
      <h4 id="itemNameHeader"></h4>
      <div class="row">
	        <div id="individualItemMonthDiv" class="col s6">
                 <select id="individualItemMonthValue" onchange="loadIndividualItemSelectedMonth()">
                 	  <option value="0">Select Month</option>
                 	  <option value="1">January</option>
	                  <option value="2">February</option>
	                  <option value="3">March</option>
              ...
              <div id="individualItemYearDiv" class="col s6">
                 <select id="individualItemYearValue" onchange="loadIndividualItemSelectedMonth()">
                  <option value="2018">2018</option>
                  <option value="2019">2019</option>
                  <option value="2020">2020</option>
                  <option value="2021">2021</option>
               ...
               <div id="individualItemPaymentList" class="col s12">
