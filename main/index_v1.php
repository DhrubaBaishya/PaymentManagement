...
<body onload="loadSelectedOption()">
  ...
  <ul id="mobile-demo" class="sidenav">
    ...
    <li><a class="sidenav-close modal-trigger" href="#addPersonPaymentModal"><i class="material-icons">person</i>Add Person Payment</a></li>
    <li><a class="sidenav-close modal-trigger" href="#addItemPaymentModal"><i class="material-icons">payment</i>Add Item Payment</a></li>
...
<!-- Modal Structure -->
    ...
    <div class="modal-content">
      <h4>Add Item Payment</h4>
      	<div class="row">
	        ...
	        <div class="input-field col s6">
	          <input placeholder="Amount with GST" id="itemTotalAmount" type="number" class="validate" disabled>
	        </div>
	    </div>
    </div>
    <div class="modal-footer">
  ...
  <div id="perItemModal" class="modal">
    <div id="perItemModalContent" class="modal-content">
